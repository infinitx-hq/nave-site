/* Puerta de entrada del recurso — /comandos y /comandos/sistema.
   PÁGINA COMPLETA: antes de ver nada, una portada con branding Nave (cosmos + verde
   + Anton) sobre un collage difuminado de los comandos UGC, bilingüe ES/EN, que pide
...
(function () {
  ...
  /* /comandos/sistema/ vive un nivel abajo del media/ publicado */
  var pre = '';  /* sin sub-paginas */
  ...
  var T = {
    es: {
      kicker: 'NAVE — RECURSO',
      h1: 'Acceso a <em>LOS 10 COMANDOS.</em>',
      sub: 'Claude Code deja de ser un chat y se vuelve tu equipo de producción de contenido:',
      b1: 'Los 10 archivos de comandos completos, listos para copiar y pegar',
      b2: 'El doc íntegro LOS 10 COMANDOS, descargable',
      b3: 'La instalación en 2 minutos, sin API keys ni herramientas de pago',
    ...
    en: {
      ...
      h1: 'Get access to <em>THE 10 COMMANDS.</em>',
      sub: 'Claude Code stops being a chat and becomes your content production team:',
      b1: 'All 10 complete command files, ready to copy and paste',
      b2: 'The full 10 COMMANDS doc, downloadable',
      b3: 'The 2-minute install, no API keys, no paid tools',
  ...
  function capture(email) {
    try {
      var payload = JSON.stringify({
        source: 'comandos', email: email, lang: lang,
